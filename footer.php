        ...
        <div class="reply">
            <div class="reply__body">
                ...
                <form action="#">
                    ...
                    <?php echo do_shortcode( '[contact-form-7 id="160" title="Форма отзыва"]' ); ?>
                    </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 col-lg-3">
                        <div class="footer__social">
                            ...
                            <a href="<?php the_field('soc_instagram', 2); ?>" target="_blank"  class="footer__social-item">
                            ...
                            <a href="<?php the_field('soc_facebook', 2); ?>" target="_blank"  class="footer__social-item">
                            ...
                            <a href="<?php the_field('soc_you_tube', 2); ?>" target="_blank"  class="footer__social-item">
